const FgEmojiPicker = function (options) {
    ...
    this.init = () => {
        ...
        this.variable.append = this.options.append || false;
    ...
    this.functions = {
        ...
        fetchEmojiData: () => {
            fetch(`https://raw.githubusercontent.com/woody180/vanilla-javascript-emoji-picker/master/full-emoji-list.json`)
    ...
    this.emojiPicker = () => {
        ...
        <div class="fg-emoji-picker">
            ...
            if (this.emojiJson) {
                ...
                fetchData = fetch(`https://raw.githubusercontent.com/woody180/vanilla-javascript-emoji-picker/master/full-emoji-list.json`)
                    .then(response => response.json())
                    .then(object => {
